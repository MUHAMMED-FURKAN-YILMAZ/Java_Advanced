...
public class G02genericsMethods {
    ...
    //dolayisiyla bir generic methodda karsilastirma icin ne kullanilabilir
    ...
    //task 1 generic method create ederek bu dizileri yazdiriniz
        printArr(intDizi);
       printArr(doubleDizi);
       printArr(charDizi);
     ...
     //task 2 max sayiyi bulan generic method yazinir. 3 pmli olsun
        ...
        System.out.println("findMax(35, 63, 34) = "+findMax(35, 63, 34));
        System.out.println("findMax(\"21\", \"35\", \"55\") ="+findMax("21", "35", "55"));
        System.out.println("findMax(35.2, 63.2,34.3 ) ="+findMax(35.2, 63.2,34.3 ));
    ...
    public static <T> void printArr(T[] dizi) {// generic method create edildi
    ...
    public static <T extends Comparable<T>> T  findMax(T a, T b, T c) {
    	...
    	if(b.compareTo(max)>0) { // b, max'dan büyükse ->1, kucukse -> -1
    		max=b;
    	}
